...
## Recent Changes
- **2025-12-03**: Added Ultraviolet & Scramjet Web Proxies
  - Integrated @nebula-services/bare-server-node for proxy backend
  - Added @titaniumnetwork-dev/ultraviolet for Ultraviolet proxy
  - Added @mercuryworkshop/scramjet for Scramjet proxy
  - Added @mercuryworkshop/bare-mux for transport handling
  ...
  - Dual proxy support - switch between Ultraviolet and Scramjet
  - Service worker-based proxies for better compatibility
  - Ultraviolet files in `frontend/uv/` directory
  - Scramjet files in `frontend/scram/` directory
  - BareMux files in `frontend/baremux/` directory
